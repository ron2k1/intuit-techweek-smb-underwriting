...
BRANCHES = [
    ...
    {
        "person": "Steven",
        "branch": "active_current_repo",
        "submission": ROOT / "outputs" / "submission" / "submission_A_decisions.csv",
        "code_root": ROOT,
        "model": "Compact raw valid-prior LightGBM + guarded hazard/recovery NPV policy",
